                  ...
                  Consumer(
                    builder: (context, ref, child) {
                      ...
                      return SwitchListTile(
                        ...
                        subtitle: const Text(
                          'Display a pin icon next to your name when you send messages from within range of a place (cities 5-15km, venues 500m). Also enables image uploads only when in range, ensuring authenticity.',
                        ),
